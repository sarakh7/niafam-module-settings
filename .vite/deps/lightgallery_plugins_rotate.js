...
var Rotate = (
  /** @class */
  function() {
    function Rotate2(instance, $LG) {
      this.core = instance;
      this.$LG = $LG;
      this.settings = __assign(__assign({}, rotateSettings), this.core.settings);
      return this;
    }
    Rotate2.prototype.buildTemplates = function() {
      var rotateIcons = "";
    ...
    Rotate2.prototype.applyStyles = function() {
    ...
    Rotate2.prototype.rotateLeft = function() {
    ...
    Rotate2.prototype.rotateRight = function() {
      this.rotateValuesList[this.core.index].rotate += 90;
      this.applyStyles();
    ...
    Rotate2.prototype.getCurrentRotation = function(el) {
      if (!el) {
        return 0;
      }
    ...
    Rotate2.prototype.flipHorizontal = function() {
    ...
    Rotate2.prototype.flipVertical = function() {
      var rotateEl = this.core.getSlideItem(this.core.index).find(".lg-img-rotate").first().get();
      var currentRotation = this.getCurrentRotation(rotateEl);
    ...
    Rotate2.prototype.triggerEvents = function(event, detail) {
      var _this = this;
      setTimeout(function() {
        _this.core.LGel.trigger(event, detail);
      }, this.settings.rotateSpeed + 10);
    };
    Rotate2.prototype.isImageOrientationChanged = function() {
    ...
    Rotate2.prototype.closeGallery = function() {
...
var lg_rotate_es5_default = Rotate;
export {
  lg_rotate_es5_default as default
};
/*! Bundled license information:

lightgallery/plugins/rotate/lg-rotate.es5.js:
  (*!
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=lightgallery_plugins_rotate.js.map
